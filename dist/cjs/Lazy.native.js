...
var import_react = __toESM(require("react")), import_react_native = require("react-native"), import_react_native_reanimated = __toESM(require("react-native-reanimated")), import_ScrollView = require("./ScrollView"), import_hooks = require("./hooks");
const Lazy = ({
  children,
  cancelLazyFadeIn,
  ...
  return canMount ? cancelLazyFadeIn ? children : /* @__PURE__ */ import_react.default.createElement(
    ...
    children
  ) : /* @__PURE__ */ import_react.default.createElement(import_ScrollView.ScrollView, null);
