...
var import_react = __toESM(require("react")), import_react_native = require("react-native"), import_react_native_reanimated = __toESM(require("react-native-reanimated")), import_helpers = require("../helpers");
const Indicator = ({
  indexDecimal,
  itemsLayout,
  style,
  ...
  }, [fadeIn]), /* @__PURE__ */ import_react.default.createElement(import_react_native_reanimated.default.View, { style: [stylez, styles.indicator, style] });
