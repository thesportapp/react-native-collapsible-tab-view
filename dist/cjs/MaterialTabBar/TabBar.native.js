...
var import_react = __toESM(require("react")), import_react_native = require("react-native"), import_react_native_reanimated = __toESM(require("react-native-reanimated")), import_Indicator = require("./Indicator"), import_TabItem = require("./TabItem");
const TABBAR_HEIGHT = 48, MaterialTabBar = ({
  ...
  return (0, import_react_native_reanimated.useAnimatedReaction)(
    ...
    itemsLayout.length === nTabs && /* @__PURE__ */ import_react.default.createElement(
