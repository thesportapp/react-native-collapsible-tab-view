...
var import_react = __toESM(require("react")), import_react_native = require("react-native"), import_react_native_reanimated = __toESM(require("react-native-reanimated"));
const TABBAR_HEIGHT = 48, DEFAULT_COLOR = "rgba(0, 0, 0, 1)", MaterialTabItem = (props) => {
  ...
  })), renderedLabel = (0, import_react.useMemo)(() => typeof label == "string" ? /* @__PURE__ */ import_react.default.createElement(import_react_native_reanimated.default.Text, { style: [styles.label, stylez, labelStyle] }, label) : label(props), [label, labelStyle, props, stylez]);
