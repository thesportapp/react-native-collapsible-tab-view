...
var import_react = __toESM(require("react")), import_helpers = require("./helpers"), import_hooks = require("./hooks"), import_jsx_runtime = require("react/jsx-runtime");
const SectionListMemo = import_react.default.memo(
  import_react.default.forwardRef((props, passRef) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_helpers.AnimatedSectionList,
    {
      ref: passRef,
      ...props
    }
...
const SectionList = import_react.default.forwardRef(SectionListImpl);
