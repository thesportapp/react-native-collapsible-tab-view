...
const ensureFlastList = () => {
  ...
  React.forwardRef((props, passRef) => (ensureFlastList(), AnimatedFlashList ? /* @__PURE__ */ React.createElement(AnimatedFlashList, { ref: passRef, ...props }) : /* @__PURE__ */ React.createElement(React.Fragment, null)))
);
